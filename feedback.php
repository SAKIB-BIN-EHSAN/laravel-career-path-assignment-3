...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (count($errors) == 0) {
        ...
        $feedbackData = $userId . ',' . $feedback . PHP_EOL;

        // Open the file for read and write
        $myfile = fopen("data/feedbackData.txt", "a") or die("Unable to open file!");
        fwrite($myfile, $feedbackData);
        fclose($myfile);

        header('Location:http://localhost:8080/feedback-success.php');
        exit;
    }
}
            ...
            <div class="mx-auto max-w-xl">
                <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                    ...
                    <div class="mt-10 mx-auto w-full max-w-xl">
                        <form class="space-y-6" action="<?= $userId; ?>" method="POST" novalidate>
                            <div>
